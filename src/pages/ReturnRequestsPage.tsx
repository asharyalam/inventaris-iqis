  ...
  return (
    <div className="flex flex-col items-center justify-start w-full max-w-4xl mx-auto p-4 space-y-8">
      <div className="text-center bg-white p-8 rounded-lg shadow-md w-full">
        <h2 className="text-4xl font-bold mb-4 text-blue-600">Permintaan Pengembalian Barang</h2>
        <p className="text-xl text-blue-600 mb-6">
          Ajukan permintaan untuk mengembalikan barang yang telah Anda pinjam.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Riwayat Pengembalian Anda</CardTitle>
          </CardHeader>
          <CardContent>
            <ReturnRequestList />
          </CardContent>
