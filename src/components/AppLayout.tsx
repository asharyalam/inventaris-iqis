...
const navItems: NavItem[] = [
  ...
  { title: "Manajemen Peminjaman Barang", href: "/admin/borrow-requests", icon: Handshake, roles: ["Admin", "Kepala Sekolah"] },
  { title: "Manajemen Pengembalian", href: "/admin/return-requests", icon: History, roles: ["Admin"] },
  { title: "Manajemen Permintaan Barang", href: "/admin/consumable-requests", icon: Package, roles: ["Admin", "Kepala Sekolah"] },
