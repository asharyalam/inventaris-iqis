...
const ReturnRequestList: React.FC = () => {
  ...
  if (!user) {
    return <div className="text-center text-red-500">Anda harus masuk untuk melihat permintaan pengembalian Anda.</div>;
  }
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <h3 className="text-2xl font-semibold mb-4">Riwayat Pengajuan Pengembalian Anda</h3>
      {requests && requests.length > 0 ? (
        ...
        <p className="text-center text-gray-500">Anda belum mengajukan pengembalian barang.</p>
      )}
    </div>
  );
};
